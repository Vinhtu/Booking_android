...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Database_BookingFood";
    ...
    public void insertUser(String username, String password, String email,String name, String phone, String address  ){
    ...
    public void insertUserModel(User user){
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put("USERNAME", user.get_username()); // Username
        values.put("PASSWORD", user.get_password()); // Password
        values.put("EMAIL", user.get_email()); //email
    ...
    public ArrayList<Product> getProductByCategory(int id) {
        ...
        while (dataFood.moveToNext()){
            productArrayList.add(new Product(dataFood.getInt(0),
                    dataFood.getString(1), dataFood.getString(2),
